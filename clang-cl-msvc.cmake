...
if(NOT EXISTS "${LLVM_NATIVE_TOOLCHAIN}/bin/clang-cl" OR
   NOT EXISTS "${LLVM_NATIVE_TOOLCHAIN}/bin/lld-link" OR
   NOT EXISTS "${LLVM_NATIVE_TOOLCHAIN}/bin/llvm-rc")
  message(SEND_ERROR
          "LLVM_NATIVE_TOOLCHAIN folder '${LLVM_NATIVE_TOOLCHAIN}' does not "
          "point to a valid directory containing bin/clang-cl, bin/lld-link and bin/llvm-rc"
          "binaries")
endif()
