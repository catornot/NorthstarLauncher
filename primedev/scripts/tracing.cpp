...
static uint64_t(__fastcall* o_pHSquirrelVMExecute)(
	HSQUIRRELVM* sqvm, uint64_t* closure, uint32_t nargs, uint32_t stackbase, SQObject* outres, int raiseerror, uint32_t et) = nullptr;
static uint64_t __fastcall h_pHSquirrelVMExecute(
	HSQUIRRELVM* sqvm, uint64_t* closure, uint32_t nargs, uint32_t stackbase, SQObject* outres, int raiseerror, uint32_t et)
{
	ZoneScoped;
